...
public class Create_New_Opportunities extends WebDriverCommomLib1
{
	...
	@FindBy(xpath="//input[@name='related_to_display']/following-sibling::img[@src='themes/softed/images/select.gif']")
	...
	public void create_potential(String potentialName,String orgName,String sales_stage ) throws Throwable
	{
